...
FUNCTION MAKE_IMAGE_C2_LIU, img, hdr, FIXGAPS=fixgaps, VIDEOIMG=videoimg, $
...
;
; 08/12/08  	CL  	- make output as FLOAT array
...
help,box_ref,box_avg
	...
	;fillcol=median(cimg(nz))
      ...
      TVCIRCLE, r_occ_out*r_sun,sunc.xcen,sunc.ycen, /FILL, /device,COLOR=1
      tmp_img = TVRD()
      ...
      TVCIRCLE, r_occ*r_sun, sunc.xcen, sunc.ycen, /FILL, /device,COLOR=fillcol

      ;** draw limb
      TVCIRCLE, r_sun, sunc.xcen, sunc.ycen, /device,COLOR=255, THICK=4
