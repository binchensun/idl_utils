...
PRO spectro_plot_bc, param0, param1, param2, param3, $
...
if n_par le 3 and not is_struct( param0 ) then begin 
    spectro_plot2_bc, param0, param1, param2, _extra = extra, $
                   cbar = cbar, $
                   charsize = charsize, $
                   xcharsize = xcharsize, $
                   xrange = xrange, $
    ...
    spectro_plot2_bc, spectro,x,y, _extra = extra, $
                   cbar = cbar, $
                   charsize = charsize, $
                   xcharsize = xcharsize, $
                   xrange = xrange, $
...
FOR i=0, n_par-1 DO BEGIN
    ...
    spectro_plot2_bc, this_spectro.spectrogram, $
