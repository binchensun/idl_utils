...
pro avgclip,arr,average,SCALE=scale,NORMALIZE=normalize,SILENT=silent, $
       ...
       VIEWIT=viewit,JUSTMEDIAN=justmedian,BAD=bad, $
       NONEWBADFLAGS=nonewbadflags,NTOPCLIP=ntopclip
   ...
   if externmean then begin
      ...
      medarr_mwb,arr,avg,bad=bad,ntopclip=ntopclip
