      ...
      if pos ne -1 then begin
         ...
         if count eq 2 then begin
            ...
            if not exists(outname) or overwrite then begin
               ...
               basphote,gain,psf*skysigma*2.0,exptime,objrad+2,objrad+2, $
                  objrad,0.0,0.0,/exact,/nolog,/silent,mag=maglimit
               basphote,gain,psf*(maxsig-avgsky),exptime,objrad+2,objrad+2, $
                  objrad,0.0,0.0,/exact,/nolog,/silent,mag=brightlimit

               list=[[xpos],[ypos],[fwhm],[mag],[err],[ra],[dec],[snr],[mag+zp]]
               sxaddpar,hdrsrc,'NAXIS2',9
               sxaddpar,hdrsrc,'PHOTZP',zp, $
                               ' Photometric zero-point correction (mag)'
               sxaddpar,hdrsrc,'MAGLIMIT',maglimit+zp, $
                               ' 2 sigma limiting magnitude'
               sxaddpar,hdrsrc,'SATLIMIT',brightlimit+zp, $
                               ' Saturation limiting magnitude'
