...
pro astrd2xy,ra,dec,info,x,y,XI=xi,ETA=eta,FULL=FULL
   ...
   if full then begin
      if info.prot ne 0 then begin
         print,self,'FATAL ERORR!'
         print,'This routine has a fundamental error if the global chip rotation'
         print,'value is non-zero.  The call to this routine must be replaced by'
         print,'a call to astcvt instead.  Questions? Contact Marc Buie'
         stop
      endif
   endif
