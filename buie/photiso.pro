...
pro photiso,gain,image,exptime,xloc,yloc,radius,sky1,sky2,ngood,zgood, $
   ...
   z=where(bad eq 0 and flux*exptime/gain lt skymean,count)
   ...
   if verbose then begin
      stats,mag[zgood]-mag1[zgood]-avgdm1,window=0,/silent,xtitle='m-m1',nbins=50
      stats,mag[zgood]-mag2[zgood]-avgdm2,window=1,/silent,xtitle='m-m2',nbins=50
      stats,mag1[zgood]-mag2[zgood]-avgdm12,window=2,/silent,xtitle='m1-m2',nbins=50
      stats,skymean[zgood],window=3,/silent,xtitle='skymean',nbins=50
      stats,xcen[zgood]-xcen1[zgood],window=4,/silent,xtitle='x-x1',nbins=50
      stats,xcen[zgood]-xcen2[zgood],window=5,/silent,xtitle='x-x2',nbins=50
      stats,ycen[zgood]-ycen1[zgood],window=6,/silent,xtitle='y-y1',nbins=50
      stats,ycen[zgood]-ycen2[zgood],window=7,/silent,xtitle='y-y2',nbins=50
   endif
